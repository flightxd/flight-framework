...
package flight.binding
{
	...
	public class PropertyChange
	{
		...
		public static function change(target:Object, property:String, oldValue:*, newValue:*):PropertyChange
		{
			var propertyChange:PropertyChange = begin();
			propertyChange.add(target, property, oldValue, newValue);
